...
|                     | Beschreibung  |
| ------------------- | ------------- |
| **Status:**         | [![Update Badi Besuch (ASE)](https://github.com/opendatazurich/automation_badi/actions/workflows/update_badi_besuch.yml/badge.svg)](https://github.com/opendatazurich/automation_badi/actions/workflows/update_badi_besuch.yml) |
| **Workflow:**       | [`update_badi_besuch.yml`](https://github.com/opendatazurich/automation_badi/blob/master/.github/workflows/update_badi_besuch.yml)    |

...
|                      | Beschreibung        |
| -------------------- | ------------------- |
| **Status:**         | [![Update Badi Aktuell (Crowd Monitor)](https://github.com/opendatazurich/automation_badi/actions/workflows/update_badi_aktuell.yml/badge.svg)](https://github.com/opendatazurich/automation_badi/actions/workflows/update_badi_aktuell.yml) |
| **Workflow:**       | [`update_badi_aktuell.yml`](https://github.com/opendatazurich/automation_badi/blob/master/.github/workflows/update_badi_aktuell.yml)   |
